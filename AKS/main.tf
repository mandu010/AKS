/*
    Grabbing Key Vault Data
*/
data "azurerm_key_vault" "azure_vault" { # Getting the Keyvault and referencing in the below steps
...
module "resourcegroup" {
    source =  "./AKS/modules/resourcegroup"  #"C:\\Learnings\\TerraformTesting\\modules\\resourcegroup"
